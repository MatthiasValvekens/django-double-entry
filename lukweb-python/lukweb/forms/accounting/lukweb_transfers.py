...
class LukwebTransferPaymentPreparator(TransferPaymentPreparator):
    ...
    def overpayment_fmt_string(self):
        return ' '.join(
            (
                ugettext(
                    'Not all bank transfer payments of %(account)s '
    ...
    def overpayment_error_params(self, debt_key, *args):
        ...
        params['account'] = str(self._by_id[debt_key])
        return params
...
class DebtTransferPaymentPreparator(LukwebTransferPaymentPreparator):
...
class ReservationTransferPaymentPreparator(LukwebTransferPaymentPreparator):
