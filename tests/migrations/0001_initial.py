# Generated by Django 2.2.6 on 2019-12-29 14:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hidden_token', models.BinaryField(default=double_entry.utils.make_token, help_text='Hidden unchanging token, for use in low-security cryptographic operations. In principle never displayed to any users.', max_length=8, verbose_name='hidden token')),
        ...
        migrations.CreateModel(
            name='SimpleCustomerDebt',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(default=django.utils.timezone.now, verbose_name='transaction timestamp')),
                ('processed', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='processing timestamp')),
                ('is_refund', models.BooleanField(default=False, editable=False, help_text='Flag indicating whether this debt record represents an overpayment refund or an unmanaged debt, rather than an actual debt record.', verbose_name='Refund/unmanaged')),
                ('debtor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='debts', to='tests.SimpleCustomer')),
                ('gnucash_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='double_entry.GnuCashCategory', verbose_name='GnuCash category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='SimpleCustomerPayment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(default=django.utils.timezone.now, verbose_name='transaction timestamp')),
                ('processed', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='processing timestamp')),
                ('creditor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='tests.SimpleCustomer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='SimpleCustomerPaymentSplit',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='EUR', max_digits=6, validators=[double_entry.models.nonzero_money_validator], verbose_name='amount')),
                ('debt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='debt_splits', to='tests.SimpleCustomerDebt')),
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_splits', to='tests.SimpleCustomerPayment')),
            ],
            options={
                'abstract': False,
            },
